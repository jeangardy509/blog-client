...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://bl0g-space.herokuapp.com/',
...
var blogEvents = __webpack_require__(14);
...
var onGetBlogs = function onGetBlogs(event) {
  event.preventDefault();
  api.getBlogs().then(ui.getBlogsSuccess).catch(ui.failure);
  $('#content').toggle();
};
var onCreateBlogs = function onCreateBlogs(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createBlogs(data).then(ui.createBlogsSuccess).catch(ui.createBlogsFailure);
};
var onUpdateBlogs = function onUpdateBlogs(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateBlogs(data).then(ui.updateBlogsSuccess).catch(ui.updateBlogsFailure);
};

var onDeleteBlogs = function onDeleteBlogs(event) {
  event.preventDefault();
  var id = event.target.dataset.id;
  api.deleteBlogs(id).then(ui.deleteBlogsSuccess).catch(ui.deleteBlogsFailure);
};
...
var createBlogs = function createBlogs(data) {
  return $.ajax({
    url: config.apiUrl + '/blogs',
    method: 'POST',
    headers: {
...
var updateBlogs = function updateBlogs(data) {
  return $.ajax({
...
var deleteBlogs = function deleteBlogs(id) {
  return $.ajax({
...
var showBlogsTemplate = __webpack_require__(17);
...
var createBlogsSuccess = function createBlogsSuccess(data) {
...
var createBlogsFailure = function createBlogsFailure() {
  // $('#blog-form').text('Wasn\'t able to create a budget, please try again!')
  // $('#blog-form').css('background-color', 'red')
  // $('#blog-form').css('color', 'white')
};

var updateBlogsSuccess = function updateBlogsSuccess() {
...
var updateBlogsFailure = function updateBlogsFailure(error) {
  console.log(error);
...
var deleteBlogsSuccess = function deleteBlogsSuccess(data) {
  // $('#blog-form').text('Your budget has been successfully created!')
  // $('#blog-form').css('background-color', 'red')
  // $('#blog-form').css('color', 'white')
};

var deleteBlogsFailure = function deleteBlogsFailure() {
  // $('#blog-form').text('Wasn\'t able to create a budget, please try again!')
  // $('#blog-form').css('background-color', 'red')
  // $('#blog-form').css('color', 'white')
};
...
module.exports = {
  createBlogsSuccess: createBlogsSuccess,
  createBlogsFailure: createBlogsFailure,
  updateBlogsSuccess: updateBlogsSuccess,
  updateBlogsFailure: updateBlogsFailure,
  getBlogsSuccess: getBlogsSuccess,
  deleteBlogsSuccess: deleteBlogsSuccess,
  deleteBlogsFailure: deleteBlogsFailure
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul data-id=\""
    ...
    + "\">\n  <div>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </div>\n</ul>\n";
  ...
  return "    <li>ID: "
    ...
    + "</li>\n      <li><button class=\"btn btn-danger delete-blog-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button></li>\n      <li><button type=\"button\" class=\"btn btn-warning update-blog-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#update-blog-modal\">Update</button></li>\n";
